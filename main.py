    ...
    def result_screen(self, player):
        ...
        while winner:
            ...
            self.window.blit(pygame.font.SysFont("Arial, Helvetica, sans-serif", 50).render(
                f"Spieler {player} hat gewonnen!", False, (0, 150, 0)), (160, 120))
            if ok:
                self.window.blit(pygame.font.SysFont("Arial, Helvetica, sans-serif",
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, speed, firerate, images):
    ...
    def move(self, entities, HEIGHT, WIDTH, left, right, up, down):
...
class Bullet(pygame.sprite.Sprite):
    ...
    def move(self, bullets, walls, player_one, player_two, HEIGHT, WIDTH, window):
        if self.direction == 0:
            self.rect.y -= self.speed
